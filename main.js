...
function getTodos() {
  ...
  // axios.get('http://jsonplaceholder.typicode.com/todos', {params: {
  //   _limit: 5
  // }})
  // .then(res => showOutput(res))
  // .catch(err => console.log(err));

  axios('http://jsonplaceholder.typicode.com/todos?_limit=5', {timeOut: 5000})
  .then(res => showOutput(res))
  .catch(err => console.log(err));
  ...
  .catch(err => {
    if(err.response){
      ...
      if(err.response.status === 404){
        ...
        // Request was made but no response found
